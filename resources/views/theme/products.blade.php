    ...
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            <div class="custom-col-8">
                <div class="single-categories-5 text-center">
                    <div class="single-categories-5-img">
                        <a href="shop.html"><img class="inject-me" src="{{ asset('theme_asset') }}/assets/images/icon-img/furniture-dress.svg" alt=""></a>
                    </div>
            ...
            <div class="custom-col-8">
                <div class="single-categories-5 text-center">
                    <div class="single-categories-5-img">
                        <a href="shop.html"><img class="inject-me" src="{{ asset('theme_asset') }}/assets/images/icon-img/furniture-headphone.svg" alt=""></a>
                    </div>
                    <div class="categorie-content-6">
            ...
            <div class="custom-col-8">
                <div class="single-categories-5 text-center">
                    <div class="single-categories-5-img">
                        <a href="shop.html"><img class="inject-me" src="{{ asset('theme_asset') }}/assets/images/icon-img/furniture-chair.svg" alt=""></a>
                    </div>
                    <div class="categorie-content-6">
            ...
            <div class="custom-col-8">
                <div class="single-categories-5 text-center">
                    <div class="single-categories-5-img">
                        <a href="shop.html"><img class="inject-me" src="{{ asset('theme_asset') }}/assets/images/icon-img/furniture-chair-2.svg" alt=""></a>
                    </div>
                    <div class="categorie-content-6">
            ...
            <div class="custom-col-8">
                <div class="single-categories-5 text-center">
                    <div class="single-categories-5-img">
                        <a href="shop.html"><img class="inject-me" src="{{ asset('theme_asset') }}/assets/images/icon-img/furniture-book.svg" alt=""></a>
                    </div>
                    <div class="categorie-content-6">
            ...
            <div class="custom-col-8">
                <div class="single-categories-5 text-center">
                    <div class="single-categories-5-img">
                        <a href="shop.html"><img class="inject-me" src="{{ asset('theme_asset') }}/assets/images/icon-img/autos.svg" alt=""></a>
                    </div>
                    <div class="categorie-content-6">
            ...
            <div class="custom-col-8">
                <div class="single-categories-5 text-center">
                    <div class="single-categories-5-img">
                        <a href="shop.html"><img class="inject-me" src="{{ asset('theme_asset') }}/assets/images/icon-img/bicycle.svg" alt=""></a>
                    </div>
                    <div class="categorie-content-6">
            ...
            <div class="custom-col-8">
                <div class="single-categories-5 text-center">
                    <div class="single-categories-5-img">
                        <a href="shop.html"><img class="inject-me" src="{{ asset('theme_asset') }}/assets/images/icon-img/fitness.svg" alt=""></a>
                    </div>
                    <div class="categorie-content-6">
